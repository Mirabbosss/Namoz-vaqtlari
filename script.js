...
getDaily(baseURL, selectedRegion)
    .then((res) => {
        ...
        createCard(res, images).forEach((el) => {
            ...
            const newElement = createElement('div', 'sm:w-[200px] md:w-[240px] lg:w-[270px] xl:w-[200px] 2xl:w-[240px] bg-[#008653] md:hover:shadow-none md:bg-[#ffffff33] px-[17px] md:px-5 py-[5px] md:py-5 w-[168px] rounded-[10px] card-shadow', `
                        <h3>${el.title}</h3>
